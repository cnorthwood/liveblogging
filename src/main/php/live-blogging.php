...
$live_blogging = new LiveBlogging();

add_action( 'init', array( $live_blogging, 'init' ) );
add_action( 'admin_init', array( $live_blogging, 'admin_init' ) );
register_activation_hook( __FILE__, array( $live_blogging, 'activate_plugin' ) );
register_deactivation_hook( __FILE__, array( $live_blogging, 'deactivate_plugin' ) );
